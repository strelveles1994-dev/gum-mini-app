...
const exerciseCatalog: ExerciseDefinition[] = [
  ...
  makeExercise({
    ...
    plan: "upper",
    name: "Жим в плечевом тренажере",
    sourceName: "Leverage Shoulder Press",
    primaryMuscles: ["shoulders"],
    secondaryMuscles: ["triceps"],
  }),
  makeExercise({
  ...
  makeExercise({
    ...
    sourceName: "Upright Barbell Row",
    primaryMuscles: ["shoulders"],
  ...
  makeExercise({
    ...
    plan: "upper",
    name: "Тяга гантели к подбородку одной рукой",
  ...
  makeExercise({
    ...
    plan: "upper",
    name: "Поочередные махи гантелями в стороны",
    sourceName: "Alternating Deltoid Raise",
    primaryMuscles: ["shoulders"],
  }),
  makeExercise({
    id: "Cable_Rear_Delt_Fly",
    plan: "upper",
    name: "Разведения в кроссовере на заднюю дельту",
  ...
  makeExercise({
    ...
    plan: "upper",
    name: "Махи в кроссовере в наклоне",
    sourceName: "Bent Over Low-Pulley Side Lateral",
    primaryMuscles: ["shoulders"],
  }),
  makeExercise({
    id: "Barbell_Rear_Delt_Row",
    plan: "upper",
    name: "Тяга штанги на заднюю дельту",
...
const legacyAliasByName: Record<string, string> = {
  ...
  "Беговая дорожка (ровный темп)": "Беговая дорожка",
  "Бег на дорожке (легкий темп)": "Беговая дорожка",
  "Бег на дорожке (интенсивный)": "Беговая дорожка",
  "Интервальный бег": "Беговая дорожка",
  "Эллипс": "Эллиптический тренажер",
  "Скакалка интервалы": "Скакалка",
  "Ходьба в горку": "Ходьба на дорожке",
  "Степпер": "Лестница",
  "Лестница (степ-милл)": "Лестница",
  "Лестница (стэрмастер)": "Лестница",
  "Step Mill": "Лестница",
  "Stairmaster": "Лестница",
  "Air Bike интервалы": "Велотренажер",
  "HIIT-круг 20/40": "Беговая дорожка",
};
